-- Ensure UtilityUI global is available for Minimap
local function SetUtilityUIGlobal()
    if _G.Nozmie_UtilityUI == nil then
        local UtilityUI = _G.Nozmie_UtilityUI or (type(UtilityUI) == "table" and UtilityUI or nil)
        if not UtilityUI then
            UtilityUI = require("UtilityUI") or {}
        end
        _G.Nozmie_UtilityUI = UtilityUI
    end
    if _G.Nozmie_UtilityUI and not _G.Nozmie_UtilityUI.Toggle then
        _G.Nozmie_UtilityUI.Toggle = UtilityUI and UtilityUI.Toggle or nil
    end
end
-- ============================================================================
